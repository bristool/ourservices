...
<div class="archive-page page-content-wrapper">
	...
	<div class="ogma-news-container">
		...
		<main id="primary" class="site-main">
			...
			<?php
				/**
				 * hook - ogma_news_before_archive_loop_content
				 *
				 * @since 1.0.0
				 */
				do_action( 'ogma_news_before_archive_loop_content' );
			...
			<?php
				...
				/**
				 * hook - ogma_news_after_archive_loop_content
				 *
				 * @since 1.0.0
				 */
				do_action( 'ogma_news_after_archive_loop_content' );
			?>
