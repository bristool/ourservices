...
$ogma_news_single_posts_related_enable = ogma_news_get_customizer_option_value( 'ogma_news_single_posts_related_enable' );

if ( false === $ogma_news_single_posts_related_enable ) {
    return;
}

/**
 * hook - ogma_news_before_single_post_related_posts_section
 *
 * @since 1.0.0
 */
do_action( 'ogma_news_before_single_post_related_posts_section' );

$ogma_news_single_posts_related_label = ogma_news_get_customizer_option_value( 'ogma_news_single_posts_related_label' );
...
?>
    <section class="single-related-posts section-column-<?php echo absint( $section_column ); ?>">
        ...
        <h2 class="related-post-title"><?php echo esc_html( $ogma_news_single_posts_related_label ); ?></h2>
...
/**
 * hook - ogma_news_after_single_post_related_posts_section
 *
 * @since 1.0.0
 */
do_action( 'ogma_news_after_single_post_related_posts_section' );