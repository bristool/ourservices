...
class Ogma_News_Latest_Posts extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            'classname'                     => 'ogma-news-widget ogma_news_latest_posts',
            'description'                   => __( 'Display latest posts in various layouts.', 'ogma-news' ),
            'customize_selective_refresh'   => true,
        );
        parent::__construct( 'ogma_news_latest_posts', __( 'OGMA NEWS: Latest Posts', 'ogma-news' ), $widget_ops );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            'widget_title' => array(
                ...
                'widget_field_default'      => __( 'Latest Posts', 'ogma-news' ),
            ...
            'posts_query_filter' => array(
                ...
                'widget_field_title'    => __( 'Posts Query Filter', 'ogma-news' ),
                'widget_field_default'  => 'latest',
                'widget_field_type'     => 'select',
                'widget_field_options'  => ogma_news_posts_query_filter_choices()
            ),
            'posts_count' => array(
                ...
                ?>
                            <div class="post-wrap <?php echo esc_attr( $post_img ); ?>">
                                ...
                                <div class="post-thumbnail-wrap">
                                    <?php ogma_news_post_thumbnail( $thumb_size ); ?>
...
} //end Class Ogma_News_Latest_Posts