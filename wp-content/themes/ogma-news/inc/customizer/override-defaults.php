...
$wp_customize->get_section( 'title_tagline' )->panel    = 'ogma_news_panel_header';
...
$wp_customize->get_section( 'header_image' )->panel     = 'ogma_news_panel_header';

$wp_customize->get_control( 'background_color' )->section    = 'background_image';
$wp_customize->get_control( 'background_color' )->priority    = 5;

$wp_customize->get_section( 'background_image' )->panel    = 'ogma_news_panel_general';
$wp_customize->get_section( 'background_image' )->title    = __( 'Background', 'ogma-news' );
