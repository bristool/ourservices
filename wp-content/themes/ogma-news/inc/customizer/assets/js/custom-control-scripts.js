...
/*--------------- Upsell ------------------------*/
    ...
    api.sectionConstructor['ogma-news-upsell'] = api.Section.extend( {
...
/*--------------- Typography Control------------------------*/
    ...
    api.controlConstructor['ogma-news-typography'] = api.Control.extend( {
        ready: function() {
            var control = this;
...
/*--------------- Block Repeater-------------------*/
    ...
    function repeater_value_refresh( _this ) {
        ...
        container.find( " > .ogma-news-block" ).each(function() {
    ...
    $( ".blocks-repeater-control-wrap" ).on( "change keyup", ".ogma-news-block .block-repeater-control-field", function() {
        var _this = $(this);
    ...
    $( ".blocks-repeater-control-wrap" ).on( "click", ".block-option", function() {
        ...
        _this.parents(".ogma-news-block").toggleClass("ogma-news-hide");
        $(this).next("input[type='checkbox']").trigger('click');
        if ( _this.hasClass( 'dashicons-hidden' ) ) {
            _this.parents(".ogma-news-block").find( ".block-content-wrap" ).slideUp( "normal");
        }
    ...
    $( ".blocks-repeater-control-wrap" ).on( "click", ".block-settings", function() {
        ...
        if ( blockOption.hasClass('dashicons-visibility') ) {
            _this.parents(".ogma-news-block").find( ".block-content-wrap" ).slideToggle();
        }
    });

    $( ".blocks-repeater-control-wrap" ).on( "click", ".ogma-news-block .close-block", function() {
        var _this = $(this);
        _this.parents(".ogma-news-block").find( ".block-content-wrap" ).slideUp( "normal");
    });

    // remove block
    $( ".blocks-repeater-control-wrap" ).on( "click", ".ogma-news-block .remove-block", function() {
        var _this = $(this), blockelement = _this.parents(".ogma-news-block"), par = blockelement.siblings( ".clone-block" );
        blockelement.find( ".block-content-wrap" ).slideUp( "normal", function() {
            $(this).parent().remove();
            repeater_value_refresh( par );
        });
        _this.parents(".ogma-news-block").find( ".block-header-icon i" ).toggleClass( "bx-chevron-up bx-chevron-down" );
    });
    ...
    $(".blocks-repeater-control-wrap").sortable({
        ...
        items: "> .ogma-news-block",
        update: function (event, ui) {
            var blockName = $(this).find( ".ogma-news-block" ).attr('block-name');
...
/*--------------- Buttonset Control ------------------------*/
    ...
    wp.customize.controlConstructor['ogma-news-buttonset'] = wp.customize.Control.extend({
        ready: function() {
            'use strict';
            var control = this;
            // Change the value
...
/*--------------- Radio Images Control ------------------------*/
    ...
    wp.customize.controlConstructor['ogma-news-radio-image'] = wp.customize.Control.extend({
        ready: function() {
            'use strict';
            var control = this;
...
/*--------------- Redirect Control ------------------------*/
    ...
    wp.customize.controlConstructor['ogma-news-redirect'] = wp.customize.Control.extend({
        ready: function() {
            'use strict';
            var control = this;
...
/*--------------- Sortable Control ------------------------*/
    ...
    wp.customize.controlConstructor['ogma-news-sortable'] = wp.customize.Control.extend({
        ready: function() {
            'use strict';
            var control = this;
...
/*--------------- Toggle Control ------------------------*/
    ...
    wp.customize.controlConstructor['ogma-news-toggle'] = wp.customize.Control.extend({
        ready: function(){
            'use strict';
            var control = this,
