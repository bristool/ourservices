...
if ( ! class_exists( 'Ogma_News_Control_Dropdown_Categories' ) ) :
	 ...
	 * @since 1.0.0
	 */
	class Ogma_News_Control_Dropdown_Categories extends WP_Customize_Control {
		 ...
		 * @since 1.0.0
		 */
		public $type = 'ogma-news-dropdown-categories';
