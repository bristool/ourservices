...
$wp_customize->register_control_type( 'Ogma_News_Control_Radio_Image' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Range' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Buttonset' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Radio_Icons' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Divider' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Redirect' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Heading' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Dropdown_Categories' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Sortable' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Typography' );
...
$wp_customize->register_control_type( 'Ogma_News_Control_Upgrade' );

// Load/Register section upsell.
require get_template_directory(). '/inc/customizer/extend-customizer/class-upsell-section.php';
$wp_customize->register_section_type( 'Ogma_News_Upsell_Section' );
